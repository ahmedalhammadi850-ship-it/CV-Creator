  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-primary">الشهادات (Certifications)</h3>
        <Button
          type="button"
          variant="outline"
          size="sm"
      ...
      <AnimatePresence>
        {fields.length === 0 && (
          ...
          >
            Add certifications or licenses (Optional)
          </motion.div>
        )}
              ...
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="col-span-1 md:col-span-2">
                        <FormLabel>Certification Name (اسم الشهادة)</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Issuer (جهة الإصدار)</FormLabel>
                        <FormControl>
